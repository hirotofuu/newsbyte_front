...
export const ArticletBar:React.FC<Props> = ({content, id_name, good, onGood, onDeleteGood}) => {
  ...
  return (
    <Box className="flex justify-between w-full fixed bottom-0 xl:hidden lg:hidden px-6 py-2 bg-gray-200">
      <Link href={`/user/${id_name}`} className="text-blue-500 font-semibold p-2">@{id_name}</Link>
